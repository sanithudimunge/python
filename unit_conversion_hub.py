...
def calculate_conversion(from_value, from_unit, to_unit, units_list):
    if units_list == length_units_list:
        # length_units_list = ['km','m', 'cm','mm','mi', 'yd', 'ft', 'in']
        length_conversion_list = [1000, 1, 1/100, 1/1000, 1609.34, 1/1.094, 1/3.281, 1/39.37]
        ...
        # mass_units_list = ['kg','g', 'mg', 'lb', 'oz']
        mass_conversion_list = [1, 1/1000, 1/1000000, 2.205, 35.274]
        ...
        volume_conversion_list = [1, 1/1000, 3.785, 1/33.814, 1/4.227]
        ...
        # speed_units_list = ['kmph', 'mps', 'mph']
        speed_conversion_list = [1/3.6, 1, 1/2.237]
        ...
        # time_units_list = ['s', 'min', 'hr', 'day', 'week', 'month', 'year']
        time_conversion_list = [1/60, 1, 60, 1440, 10080, 43800, 525600]
...
def get_list_name(current_unit_list):
    if current_unit_list == length_units_list:
        return 'length'
    elif current_unit_list == mass_units_list:
        return 'mass / weight'
    elif current_unit_list == vol_units_list:
        return 'volume'
    elif current_unit_list == speed_units_list:
        return 'speed'
    elif current_unit_list == temp_units_list:
        return 'temperature'
    elif current_unit_list == time_units_list:
        return 'time'
...
if menu_input == '1':
    ...
    print(length_from_value, length_from_unit, '=', length_to_value, length_to_unit)
...
# Mass / Weight
    ...
    print(mass_from_value, mass_from_unit, '=', mass_to_value, mass_to_unit)
...
# Volume
    ...
    print(vol_from_value, vol_from_unit, '=', vol_to_value, vol_to_unit)
...
# Speed
    ...
    print(speed_from_value, speed_from_unit, '=', speed_to_value, speed_to_unit)
...
# Temperature
    ...
    print(temp_from_value, temp_from_unit, '=', temp_to_value, temp_to_unit)
...
# Time
    ...
    print(time_from_value, time_from_unit, '=', time_to_value, time_to_unit)
...
# Direct Search feature
    ...
    current_unit_list = []
    while True:
        search_from_unit = input('\nWhat unit would you like to convert from? ')
        for unit_list in all_units_list:
            if search_from_unit in unit_list:
                current_unit_list = unit_list
                print('\nYou are currently performing a', get_list_name(current_unit_list), 'conversion.')
                print('Pick a unit from list below.')
                break
    ...
    print(search_from_value, search_from_unit, '=', search_to_value, search_to_unit)
